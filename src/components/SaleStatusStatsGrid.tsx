    ...
    >
      <div className="flex items-center justify-between mb-[16px]">
        ...
        <div className="flex border border-[#cbd5e1] rounded-[8px] overflow-hidden">
          <button
            ...
            className={clsx(
              "px-[14px] py-[6px] text-[15px] font-bold border-none cursor-pointer",
      ...
      <div className="grid grid-cols-[repeat(auto-fit,minmax(140px,1fr))] gap-[12px]">
        {STATUS_ITEMS.map((item) => (
          ...
          >
            <div className="text-[14px] font-bold text-[#334155] uppercase tracking-[0.3px] mb-[6px]">
              {item.label}
            </div>
            <div className="text-[27px] font-black text-[#0f172a] mb-[4px]">
              {current[item.key]}
            </div>
