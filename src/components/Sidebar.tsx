  ...
  return (
    ...
    >
      ...
      >
        ...
        <span className="text-[16px] font-extrabold text-[#0f172a] tracking-[-0.2px] opacity-0 whitespace-nowrap transition-opacity duration-150 group-hover/sidebar:opacity-100">
          Viễn Chí Bảo 
        </span>
      </button>
