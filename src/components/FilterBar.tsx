  ...
  return (
    <div className="bg-surface border border-border rounded-[12px] py-[10px] px-[14px] mb-[10px] flex flex-col gap-[10px]">
      ...
      <div className="grid [grid-template-columns:repeat(auto-fit,minmax(120px,1fr))] gap-[8px]">
        ...
        >
          <div className="text-[12.5px] font-bold text-muted uppercase tracking-[0.3px] mb-[2px]">
            Tất cả
          </div>
        ...
        {STATUS_SQUARES.map((s) => {
          ...
          return (
            ...
            >
              <div className="text-[12.5px] font-bold text-muted uppercase tracking-[0.3px] mb-[2px] overflow-hidden text-ellipsis whitespace-nowrap">
                {s.label}
              </div>
              <div className="text-[17px] font-black text-[#0f172a]">
                {counts[s.countKey]}
        ...
        <div className="flex items-center gap-[10px] flex-wrap">
          ...
          <div className="relative w-[260px]">
            ...
            <input
              ...
              className="w-full bg-[#f8fafc] border border-[#cbd5e1] rounded-[8px] pt-[8px] pr-[12px] pb-[8px] pl-[34px] text-[14.5px] text-[#0f172a] outline-none box-border"
            />
          </div>
          ...
          <button
            ...
            disabled={!isFiltered}
            className={clsx(fbBtnCls, '!py-[8px] !px-[14px] !text-[14px] flex items-center gap-[4px] shrink-0')}
