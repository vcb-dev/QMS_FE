...
export const ImageLightbox: React.FC<ImageLightboxProps> = ({ images, activeIndex, onIndexChange, onClose }) => {
  ...
  return createPortal(
    ...
    >
      ...
      <span
        className="fixed top-[24px] left-1/2 -translate-x-1/2 text-[rgba(255,255,255,0.9)] text-[17px] font-bold bg-[rgba(0,0,0,0.5)] backdrop-blur-[4px] py-[6px] px-[16px] rounded-[20px] z-10 tracking-[0.3px]"
      >
