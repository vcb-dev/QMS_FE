...
export const Pagination: React.FC<PaginationProps> = ({
  ...
  return (
    <div className="flex items-center justify-between py-[12px] px-[16px] bg-white border-t border-[#e2e8f0] rounded-b-[10px] text-[14.5px] text-[#334155]">
      ...
      <div className="flex items-center gap-[14px]">
        ...
        <div className="flex items-center gap-[6px]">
          ...
          <select
            ...
            className="py-[4px] px-[8px] rounded-[6px] border border-[#cbd5e1] bg-[#f8fafc] text-[14px] font-semibold outline-none cursor-pointer"
          >
      ...
      <div className="flex items-center gap-[4px]">
        ...
        {getPageNumbers().map((page) => (
          <button
            ...
            className={clsx(
              "py-[4px] px-[10px] rounded-[6px] text-[14px] cursor-pointer min-w-[28px]",
              page === currentPage
