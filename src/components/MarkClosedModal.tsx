    ...
    <div className={modalBackdropCls}>
      ...
      >
        ...
        <div className={modalBodyCls}>
          <p className="text-[16.5px] text-[#334155] m-0 mb-[12px]">
              ...
              return (
                ...
                >
                  <span className="flex flex-col gap-[3px]">
                    <span className="text-[17.5px] font-bold text-[#0f172a]">{label}</span>
                    {summary && (
                  ...
                  <span className="flex items-center gap-[8px] shrink-0">
                    <div className="flex flex-col items-end">
                      <strong className="text-[18px] font-black text-[#16a34a]">
