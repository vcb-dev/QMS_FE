      ...
      return (
        <div className="flex-1 flex items-center justify-center p-[24px] box-border">
          <div className="w-full max-w-[440px] bg-surface border border-border rounded-[16px] p-[24px] text-center">
            ...
            <h2 className="text-[18px] font-extrabold text-[#0f172a] m-0 mb-[6px]">
              Trang này gặp lỗi hiển thị
            </h2>
            <p className="text-[15px] text-muted m-0 mb-[16px] leading-[1.5]">
            ...
            <div className="flex gap-[10px] justify-center flex-wrap">
              <button
                ...
                className="inline-flex items-center gap-[7px] bg-[#0f172a] text-white border-0 rounded-[10px] py-[9px] px-[16px] text-[15px] font-bold cursor-pointer"
              >
              ...
              <button
                ...
                className="inline-flex items-center gap-[7px] bg-[#f8fafc] text-[#334155] border border-[#cbd5e1] rounded-[10px] py-[9px] px-[16px] text-[15px] font-bold cursor-pointer"
              >
                <Home size={15} /> Về trang chủ
              </button>
            </div>
            {error?.message && (
              <p className="mt-[14px] mb-0 text-[13.5px] font-mono text-[#dc2626] [word-break:break-word]">
          ...
          <div className="w-full max-w-[560px] bg-surface rounded-[24px] overflow-hidden shadow-[0_25px_50px_-12px_rgba(0,0,0,0.5),0_0_0_1px_rgba(255,255,255,0.1)]">
            ...
            <div className="pt-[36px] px-[32px] pb-[32px]">
              ...
              <div className="flex flex-col items-center text-center mb-[24px]">
                ...
                <h1 className="text-[22px] font-extrabold text-[#0f172a] m-0 mb-[8px] tracking-[-0.3px]">
                  Đã xảy ra sự cố không mong muốn
                </h1>
                <p className="text-[15.5px] text-muted m-0 leading-[1.5] max-w-[420px]">
              ...
              <div className="flex gap-[12px] justify-center mb-[20px] flex-wrap">
                <button
                  ...
                  className="flex-1 min-w-[160px] inline-flex items-center justify-center gap-[8px] bg-[#0f172a] text-white border-0 rounded-[12px] py-[12px] px-[20px] text-[15.5px] font-bold cursor-pointer shadow-[0_4px_12px_rgba(15,23,42,0.25)] transition-[all_0.15s_ease]"
                >
                ...
                <button
                  type="button"
                  onClick={this.handleGoHome}
                  className="flex-1 min-w-[160px] inline-flex items-center justify-center gap-[8px] bg-[#f8fafc] text-[#334155] border border-[#cbd5e1] rounded-[12px] py-[12px] px-[20px] text-[15.5px] font-bold cursor-pointer transition-[all_0.15s_ease]"
                >
              ...
              <div className="border border-border rounded-[14px] bg-[#f8fafc] overflow-hidden transition-[all_0.2s_ease]">
                <button
                  ...
                  className="w-full py-[12px] px-[16px] flex items-center justify-between bg-transparent border-0 cursor-pointer text-[#475569] text-[14.5px] font-bold"
                >
                  ...
                  <div className="pt-0 px-[16px] pb-[16px] border-t border-border">
                    <div className="flex justify-between items-center my-[12px] mb-[8px] gap-[8px] flex-wrap">
                      ...
                      <button
                        ...
                        className={clsx(
                          'inline-flex items-center gap-[6px] py-[4px] px-[10px] rounded-[6px] border border-[#cbd5e1] text-[13px] font-bold cursor-pointer',
                    ...
                    <div className="bg-[#0f172a] text-[#f87171] rounded-[8px] p-[12px] text-[13px] font-mono max-h-[160px] overflow-y-auto whitespace-pre-wrap [word-break:break-all] leading-[1.5]">
