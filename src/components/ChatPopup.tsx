    ...
    <>
      ...
      >
        ...
        {!isOpen && connected && unreadCount > 0 && (
          <span className="absolute top-[-2px] right-[-2px] bg-[#ef4444] text-white rounded-full text-[12px] font-extrabold min-w-[20px] h-[20px] flex items-center justify-center py-0 px-[4px]">
        ...
        <div className="fixed bottom-[90px] right-[24px] z-[9990] w-[340px] h-[440px] bg-surface rounded-[14px] shadow-[0_12px_32px_rgba(0,0,0,0.2)] flex flex-col overflow-hidden">
          <div className="bg-[#0f172a] text-white py-[12px] px-[16px] flex items-center justify-between">
            <div className="flex items-center gap-[8px]">
              <span className="font-bold text-[14.5px]">Trao đổi</span>
            ...
            {messages.map((m) => {
              ...
              return (
                <div key={m.id} className={clsx('flex flex-col', mine ? 'items-end' : 'items-start')}>
                  <div
                    className={clsx(
                      'max-w-[80%] py-[8px] px-[12px] rounded-[12px] text-[14px] transition-opacity duration-200',
                  ...
                  <span className="text-[11px] text-faint mt-[2px] flex items-center gap-[4px]">
          ...
          {!connected && (
            <div className="py-[4px] px-[12px] text-[12px] text-[#ef4444] bg-[#fef2f2]">
          ...
          <div className="flex items-center gap-[6px] p-[10px] border-t border-border">
            ...
            <input
              ...
              disabled={!connected}
              className={clsx(
                'flex-1 border border-[#cbd5e1] rounded-[20px] py-[8px] px-[14px] text-[14px] outline-none',
