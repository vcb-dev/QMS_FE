      ...
      >
        <div className={clsx(modalHeaderCls, 'shrink-0')}>
          <div className="min-w-0">
            <h2 className="text-[16px] overflow-hidden text-ellipsis whitespace-nowrap">{item.productName}</h2>
          </div>
            ...
            {history.length === 0 ? (
              ...
              <div className="flex flex-col gap-[8px]">
                {history.map((h, idx) => (
                  ...
                  >
                    <div className="flex items-baseline justify-between gap-[8px] mb-[1px]">
                      <span className="text-[11.5px] font-bold text-muted [font-variant-numeric:tabular-nums] tracking-[0.2px]">{h.code}</span>
                      <span className="shrink-0 text-[13px] font-extrabold text-[#0f172a] [font-variant-numeric:tabular-nums] text-right">
                    ...
                    <div className="mt-[5px] pt-[6px] border-t border-dashed border-border text-[12.5px] text-muted [&_strong]:text-[#0f172a] [&_strong]:font-extrabold">
                ...
                {histPage < histTotalPages && (
                  <div
                    ref={histSentinelRef}
                    className="flex items-center justify-center min-h-[34px] mt-[2px] text-[11.5px] font-bold tracking-[0.5px] uppercase text-faint"
                  >
          ...
          <section className={clsx(specColCls, 'max-[860px]:order-2')}>
            <div className={specEyebrowCls}>
              ...
              {selected && selected.options.length > 1 && (
                <button
                  type="button"
                  className="flex items-center gap-[5px] shrink-0 py-[4px] px-[9px] text-[11px] font-bold tracking-[0.3px] text-muted bg-white border border-border rounded-[7px] cursor-pointer data-[copied]:text-[#15803d] data-[copied]:bg-[#dcfce7] data-[copied]:border-[#bbf7d0]"
            ...
            {selected && selected.options.length > 0 ? (
              <div className="flex flex-col">
                {quotedWhen && (
                  <div className="text-[11px] font-extrabold uppercase tracking-[0.4px] text-faint mb-[10px]">
                ...
                {selected.options.map((o, idx) => {
                  ...
                  const rowLabelCls = 'text-left text-[10.5px] font-bold uppercase tracking-[0.3px]';
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-center gap-[6px]">
                        <span className="flex-1 min-w-0 text-[13px] text-muted truncate">{o.optionName}</span>
                        {oTag && (
                          <span
                            className={clsx(
                              'shrink-0 py-[2px] px-[7px] text-[10.5px] font-extrabold tracking-[0.3px] rounded-full',
                              oTag.className,
                            )}
                          >
                            {oTag.label}
                      ...
                      <table className="w-full text-[12.5px] [font-variant-numeric:tabular-nums] border-collapse [&_td]:py-[2px] [&_th]:py-[2px]">
                        <thead>
                          <tr className="text-[10px] font-extrabold uppercase tracking-[0.4px] text-faint">
                      ...
                      {hasLive && dp !== 0 && (
                        <div
                          className={clsx(
                            'flex items-center justify-end gap-[3px] text-[11.5px] font-bold [&_svg]:shrink-0',
                            deltaCls,
                          )}
                        >
