      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-[10px]">
          ...
          {(currentRole === 'SALE' || currentRole === 'ORDER') && (
            <label className="flex items-center gap-[6px] bg-surface border border-[#cbd5e1] rounded-[8px] py-[7px] px-[12px] text-[13.5px] font-bold text-[#334155] cursor-pointer select-none">
              <input
                type="checkbox"
                checked={isMineOnly}
