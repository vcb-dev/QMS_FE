...
const Badge: React.FC<{ on: boolean }> = ({ on }) => (
  <span
    className={clsx(
      'inline-flex items-center gap-[6px] text-[13.5px] font-bold py-[3px] px-[9px] rounded-full',
      on
    ...
    <div className="flex flex-col">
      <div className="bg-surface border border-[#e5e7eb] rounded-[16px]">
        ...
        <div className="pt-[22px] px-[22px] pb-0">
          <div className="flex items-start justify-between gap-[16px] flex-wrap">
            <div>
              <h1 className="text-[26px] font-black text-[#0f172a] mb-[4px] tracking-[-0.3px] flex items-center gap-[10px]">
                <Bell size={22} /> Cấu hình thông báo Lark
              </h1>
              <p className="m-0 text-[14.5px] text-[#334155] max-w-[620px] leading-[1.5]">
        ...
        <div className="pt-[18px] px-[22px] pb-[22px] flex flex-col gap-[16px]">
          {error && (
            <div className="flex gap-[6px] items-start text-[#b91c1c] text-[14px] bg-[#fef2f2] border border-[#fca5a5] py-[9px] px-[11px] rounded-[8px]">
              <AlertTriangle
                size={14}
          ...
          <div className="grid grid-cols-3 gap-[10px]">
            {statCards.map((c, i) => (
              ...
              >
                <div className="text-[20px] font-extrabold text-[#0f172a] tabular-nums">
                  {c.num}
                </div>
                <div className="text-[13.5px] text-[#334155] mt-[2px]">
                  {c.label}
                </div>
              </div>
            ))}
          ...
          {/* list */}
          <div>
            <h3 className="text-[15.5px] font-extrabold text-[#0f172a] mb-[10px]">
              Danh sách webhook
            </h3>
                  ...
                  <tbody>
                    {loading ? (
                      <tr>
                        <td
                          colSpan={6}
                          className="p-[38px] text-center text-[#334155] text-[15px]"
                        >
                          <Loader2
                            size={16}
                      ...
                      <tr>
                        ...
                        >
                          ...
                          />
                          <div className="text-[#0f172a] font-bold text-[15.5px]">
                            {stats.total === 0
                              ? 'Chưa có webhook nào'
                      ...
                      list.map((w) => (
                        ...
                        >
                          <td className={clsx(tdCls, 'py-[12px] px-[16px] align-top')}>
                            ...
                            <div className="text-[13px] text-[#64748b] mt-[1px]">
                              {w.botName
                                ? `Bot: ${w.botName}`
                                : 'Chưa đặt tên bot'}
                            </div>
                          ...
                          <td className={clsx(tdCls, 'py-[12px] px-[16px] align-top')}>
                            <div className="flex items-center gap-[6px]">
                              <code
                                title={w.webhookUrl}
                                className="text-[13.5px] text-[#334155] bg-[#f1f5f9] py-[3px] px-[7px] rounded-[6px] font-mono"
                              >
                          ...
                          <td className={clsx(tdCls, 'py-[12px] px-[16px] align-top')}>
                            {w.actions.length === 0 ? (
                              <span className="text-[14px] text-[#64748b] italic">
                              ...
                              <div className="flex flex-wrap gap-[5px] max-w-[320px]">
                                {w.actions.map((a) => (
                                  <span
                                    key={a}
                                    className="text-[13px] font-semibold text-[#475569] bg-[#f1f5f9] border border-[#e5e7eb] rounded-full py-[2px] px-[8px] inline-flex items-center"
                                  >
                                    {labelOf(a)}
                                  </span>
                                ))}
                          ...
                          <td className={clsx(tdCls, 'py-[12px] px-[16px] text-[14px] text-[#334155] align-top')}>
              ...
              <div className={clsx(modalBodyCls, '!gap-[13px] !py-[18px] !px-[20px] flex-1 min-h-0 overflow-y-auto')}>
                <div className="grid grid-cols-2 gap-[12px]">
                  <div className={formGroupCls}>
                    ...
                    />
                    {formErr.chatName && (
                      <span className="text-[13.5px] text-[#ef4444]">
                        {formErr.chatName}
                      </span>
                    )}
                  </div>
                ...
                <div className={formGroupCls}>
                  ...
                  <span className="text-[13.5px] text-[#334155] leading-[1.45] block mb-[4px]">
                  </span>
                  ...
                  {form.actions.length > 0 && (
                    <div className="flex flex-wrap gap-[5px] mt-[2px]">
                      {form.actions.map((a) => (
                        <span
                          key={a}
                          className="inline-flex items-center gap-[5px] text-[13px] font-medium text-[#0f172a] bg-[#f1f5f9] border border-[#e5e7eb] rounded-full pt-[2px] pr-[4px] pb-[2px] pl-[9px]"
                        >
                          {labelOf(a)}
                          <button
                            type="button"
                  ...
                  {(() => {
                    ...
                    return (
                      <div className="border border-[#e5e7eb] rounded-[10px] mt-[4px] max-h-[166px] overflow-y-auto">
                          {hits.length === 0 ? (
                            <div className="p-[12px] text-[14px] text-[#64748b]">
          ...
          >
            ...
            >
              ...
              <div className={modalBodyCls}>
                <p className="m-0 text-[14.5px] text-[#334155] leading-[1.55]">
      ...
      {toast &&
        createPortal(
          <div
            className={clsx(
              'fixed bottom-[24px] left-1/2 -translate-x-1/2 text-surface py-[11px] px-[18px] rounded-[10px] text-[14.5px] font-semibold flex items-center gap-[9px] shadow-[0_10px_30px_rgba(0,0,0,0.25)] z-[1100] max-w-[90vw]',
