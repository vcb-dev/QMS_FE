      ...
      <div className="w-full max-w-[420px] m-auto bg-[#fffdf9] rounded-[20px] overflow-hidden shadow-[0_30px_60px_-15px_rgba(0,0,0,0.5)] shrink-0">
        ...
        <div className="pt-[32px] px-[36px] pb-[36px]">
          ...
          <div className="text-center mb-[22px]">
            ...
            />
            <h1 className="text-[21px] font-extrabold text-[#1f2937] m-0">
              {modeCopy[mode].title}
            </h1>
            <p className="text-[14px] text-[#9ca3af] mt-[4px] mr-0 mb-0 ml-0 tracking-[0.3px]">
          ...
          {/* Feedback Alerts */}
          {errorMsg && (
            <div className="bg-[#fef2f2] border border-[#fca5a5] text-[#b91c1c] py-[10px] px-[14px] rounded-[10px] text-[14.5px] mb-[16px] text-center">
              {errorMsg}
            </div>
          )}

          {successMsg && (
            <div className="bg-[#f0fdf4] border border-[#86efac] text-[#15803d] py-[10px] px-[14px] rounded-[10px] text-[14.5px] mb-[16px] flex items-center justify-center gap-[8px]">
          ...
          {mode === 'login' && (
            <>
              <form onSubmit={handleLoginSubmit} className="flex flex-col gap-[16px]">
                ...
                <div className="flex flex-col gap-[6px]">
                  <div className="flex justify-between items-center">
                    ...
                    <button
                      ...
                      className="bg-transparent border-0 text-[#b45309] text-[14px] cursor-pointer p-0 font-semibold"
                    >
                      Quên mật khẩu?
                    </button>
                  </div>
                ...
                <label className="flex items-center gap-[8px] text-[14.5px] text-[#4b5563] font-semibold cursor-pointer">
                  <input
                    type="checkbox"
                    checked={rememberMe}
              ...
              <div className="mt-[20px] flex flex-col gap-[16px]">
                <div className="flex items-center gap-[10px]">
                  ...
                  <span className="text-[14px] text-[#9ca3af] font-semibold">HOẶC</span>
                  <div className="flex-1 h-[1px] bg-[#e5e7eb]"></div>
                </div>
                ...
                <button
                  ...
                  className={clsx(
                    'grid grid-cols-[1fr_auto_1fr] items-center w-full py-[6px] px-0 bg-surface border border-[#d1d5db] rounded-[12px] text-[16.5px] font-semibold text-[#374151] shadow-[0_2px_4px_rgba(0,0,0,0.02)] transition-all duration-200',
              ...
              <p className="text-center text-[14.5px] text-[#9ca3af] mt-[24px]">
                Chưa có tài khoản?{' '}
                <button
                  type="button"
                  onClick={() => goToMode('register')}
                  className="bg-transparent border-0 text-[#b45309] font-bold text-[14.5px] cursor-pointer p-0"
                >
          ...
          {mode === 'forgot' && (
            <form onSubmit={handleForgotPasswordSubmit} className="flex flex-col gap-[16px]">
              <p className="text-[15px] text-[#6b7280] leading-[1.5] m-0 text-center">
          ...
          {mode === 'reset' && (
            <form onSubmit={handleResetPasswordSubmit} className="flex flex-col gap-[14px]">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-[linear-gradient(135deg,#16a34a_0%,#15803d_100%)] text-surface border-0 rounded-[10px] p-[13px] text-[16.5px] font-bold cursor-pointer flex items-center justify-center gap-[8px] shadow-[0_6px_16px_rgba(22,163,74,0.35)]"
              >
