  ...
  return (
    <>
      <div className="flex items-center justify-between">
        <h1 className="text-[22px] font-extrabold text-[#0f172a] mt-[2px] flex items-center gap-[10px]">
        ...
        actions={
          <>
            {(currentRole === 'SALE' || currentRole === 'ADMIN') && (
              <button
                className="bg-[#f1f5f9] text-[#334155] border border-[#cbd5e1] py-[8px] px-[18px] rounded-[10px] font-extrabold text-[15px] cursor-pointer inline-flex items-center gap-[6px] transition-[background_0.15s,border-color_0.15s] hover:bg-[#e2e8f0] hover:border-[#94a3b8]"
            ...
            {onOpenExport && (
              <button
                ...
                className="inline-flex items-center gap-[6px] bg-[#f0fdf4] text-[#15803d] border border-[#bbf7d0] rounded-[8px] py-[8px] px-[14px] text-[15px] font-bold cursor-pointer"
