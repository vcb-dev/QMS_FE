        ...
        {(currentRole === 'ORDER' || currentRole === 'ADMIN') &&
          selectedReq.status === 'PENDING' && (
            <button
              ...
              className="bg-[#16a34a] text-surface border-0 rounded-[10px] py-[9px] px-[18px] text-[14px] font-extrabold cursor-pointer shadow-sm"
            >
              Báo giá luôn
            </button>
          )}
              ...
              <div className="flex flex-col gap-[14px]">
                ...
                {selectedReq.note && (
                  <div className="bg-page border border-border rounded-[10px] p-[14px]">
                    ...
                    <p className="text-[13.5px] text-[#334155] m-0 leading-[1.5] whitespace-pre-wrap break-words">
