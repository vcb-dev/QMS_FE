      ...
      <div className="flex items-center justify-between border-b border-border pb-[16px]">
        <div className="flex items-center gap-[14px]">
          <button
            type="button"
            onClick={onBack}
            className="bg-surface border border-[#cbd5e1] rounded-[10px] py-[8px] px-[16px] text-[15px] font-bold text-[#334155] cursor-pointer flex items-center gap-[6px] shadow-sm transition-[all_0.15s_ease]"
          >
            <ArrowLeft size={16} /> 
          </button>
          ...
          <div>
            <div className="flex items-center gap-[10px]">
              <h1 className="text-[24px] font-black text-text m-0">
        ...
        {(currentRole === 'ORDER' || currentRole === 'ADMIN') &&
          selectedReq.status === 'PENDING' && (
            <button
              ...
              className="bg-[#16a34a] text-surface border-0 rounded-[10px] py-[9px] px-[18px] text-[15px] font-extrabold cursor-pointer shadow-sm"
            >
              Báo giá luôn
            </button>
          )}
        ...
        <div className="flex flex-col gap-[20px]">
          ...
          {(selectedReq.status === 'REJECTED' ) && selectedReq.rejectReason && (
            <div className="bg-[#fff1f2] border border-[#fecdd3] rounded-[12px] py-[16px] px-[20px]">
              <div className="text-[15px] font-extrabold text-[#be123c] flex items-center gap-[8px]">
                <XCircle size={18} /> LÝ DO TỪ CHỐI HẲN
              </div>
              <p className="text-[15px] text-[#9f1239] mt-[6px] mr-0 mb-0 ml-0 leading-[1.5]">
          ...
          {selectedReq.status === 'NEED_MORE_INFO' && selectedReq.returnReason && (
            <div className="bg-[#fff7ed] border border-[#ffedd5] rounded-[12px] py-[16px] px-[20px]">
              <div className="text-[15px] font-extrabold text-[#c2410c] flex items-center gap-[8px]">
                <RotateCcw size={18} /> YÊU CẦU BỔ SUNG THÔNG TIN
              </div>
              <p className="text-[15px] text-[#9a3412] mt-[6px] mr-0 mb-0 ml-0 leading-[1.5]">
          ...
          {selectedReq && (selectedReq.status !== 'QUOTED' && selectedReq.status !== 'CLOSED') && priceVal > 0 && currentRole === 'SALE' && (
            <div className="bg-[#fff7ed] border-[1.5px] border-[#fed7aa] rounded-[12px] py-[16px] px-[20px] flex items-center gap-[14px] shadow-[0_2px_6px_rgba(234,88,12,0.08)]">
              ...
              <div>
                <div className="text-[15.5px] font-extrabold text-[#c2410c]">
                  GIÁ CHƯA ĐƯỢC XÁC NHẬN BỞI ADMIN / ORDER
                </div>
                <p className="text-[14.5px] text-[#9a3412] mt-[4px] mr-0 mb-0 ml-0 leading-[1.5] font-semibold">
          ...
          <div className={cardCls}>
            <h2 className="text-[20px] font-black text-text mb-[16px]">
            ...
            <div className="grid grid-cols-[260px_1fr] gap-[20px]">
              ...
              <div>
                ...
                >
                  ...
                  {mediaList.length > 1 && (
                    <>
                      <span
                        className="absolute bottom-[10px] right-[10px] bg-[rgba(15,23,42,0.85)] backdrop-blur-[4px] text-surface text-[14.5px] font-extrabold py-[5px] px-[12px] rounded-[20px] border border-[rgba(255,255,255,0.25)] shadow-[0_2px_6px_rgba(0,0,0,0.25)] flex items-center gap-[5px] pointer-events-none"
                      >
              ...
              <div className="flex flex-col gap-[14px]">
                ...
                <div className="bg-page border border-border rounded-[10px] p-[14px]">
                  <span className="text-[13px] font-extrabold text-muted uppercase block mb-[4px]">
                    GHI CHÚ / MÔ TẢ YÊU CẦU CỦA KHÁCH HÀNG
                  </span>
                  <p className="text-[14.5px] text-[#334155] m-0 leading-[1.5]">
                ...
                {selectedReq.note && (
                  <div className="bg-page border border-border rounded-[10px] p-[14px]">
                    ...
                    <p className="text-[14.5px] text-[#334155] m-0 leading-[1.5] whitespace-pre-wrap break-words">
          ...
          {selectedReq.status !== 'CLOSED' && selectedReq.status !== 'PENDING' && pricedOptions.length > 0 && (
            <div className={cardCls}>
              <div className="flex items-center justify-between mb-[16px]">
                <h3 className="text-[18px] font-extrabold text-text m-0 flex items-center gap-[8px]">
                ...
                {pricedOptions.length > 1 && (
                  <button
                    ...
                    className={clsx(
                      'flex items-center gap-[6px] py-[6px] px-[12px] rounded-[8px] border border-[#cbd5e1] text-[14px] font-bold cursor-pointer',
        ...
        <div className="flex flex-col gap-[20px]">
          ...
          >
            <div className="flex items-center justify-between border-b border-[#e5e7eb] pb-[12px]">
              <span className="text-[16px] font-extrabold text-[#111827] flex items-center gap-[6px]">
                <BarChart3 size={16} color="#4b5563" /> Bảng Kê Giá & VAT
              </span>
              <span className="text-[13px] font-mono text-[#4b5563] bg-surface py-[2px] px-[8px] rounded-[6px] border border-[#e5e7eb]">
                {selectedReq.code || `#${selectedReq.id}`}
              </span>
            </div>

            <div className="bg-surface rounded-[12px] p-[16px] border border-[#e5e7eb] mt-[4px]">
              <span className="text-[12.5px] font-extrabold text-[#6b7280] tracking-[0.5px] uppercase block">
                TỔNG BÁO GIÁ CHỐT
              </span>
              <div
                className={clsx(
                  'text-[28px] font-black mt-[4px]',
                  priceVal > 0
              ...
              {priceVal > 0 && currentRole === 'SALE' && finalOption && finalOption.vat != null && (
                <div className={clsx('mt-[8px] text-[13.5px] font-bold', finalOption.vat > 0 ? 'text-[#0f172a]' : 'text-[#64748b]')}>
              ...
              {priceVal > 0 && (currentRole === 'ORDER' || currentRole === 'ADMIN') && finalOption &&
               (finalOption.weightChi != null || finalOption.totalMetalCost != null || finalOption.laborCost != null || finalOption.stonePrice != null || finalOption.stoneCost != null || finalOption.vat != null) && (
                <div className="flex flex-col gap-[5px] mt-[10px] pt-[10px] border-t border-dashed border-border text-[13.5px] text-[#475569]">
                  ...
                  {finalOption.totalMetalCost != null && finalOption.metalRawCost == null && (finalOption.laborCost != null || finalOption.vat != null) && (
                    <div className="text-[12.5px] text-[#64748b] italic mt-[2px]">
          ...
          <div className={cardCls}>
            <h3 className="text-[17px] font-extrabold text-[#0f172a] mb-[14px] border-b border-[#f1f5f9] pb-[10px]">
              Thông Tin Đơn Yêu Cầu
            </h3>

            <div className="flex flex-col gap-[12px] text-[15px]">
              <div>
                <span className="text-[13px] text-[#334155] font-bold uppercase">THÔNG TIN KHÁCH HÀNG</span>
                <div className="font-extrabold text-[#0f172a] text-[16px] mt-[2px] flex items-center gap-[6px]">
                  <UserIcon size={15} color="#2563eb" /> {selectedReq.customerName || selectedReq.customer?.name || 'Khách hàng lẻ'}
                </div>
                {selectedReq.customer?.phone && (
                  <div className="text-[14px] text-[#475569] mt-[4px] flex items-center gap-[6px]">
                    <Phone size={13} color="#64748b" /> SĐT: {selectedReq.customer.phone}
                  </div>
                )}
                {selectedReq.customer?.province && (
                  <div className="text-[14px] text-[#475569] font-bold mt-[4px] flex items-center gap-[6px]">
              ...
              <div>
                <span className="text-[13px] text-[#334155] font-bold uppercase">NGÀY MONG MUỐN NHẬN HÀNG</span>
              ...
              <div className="mt-[4px] pt-[14px] border-t border-border">
                <span className="text-[12px] font-extrabold text-[#64748b] uppercase tracking-[0.6px]">
                  Xử Lý Nội Bộ
                </span>
              </div>

              <div>
                <span className="text-[13px] text-[#334155] font-bold uppercase">NGƯỜI TẠO YÊU CẦU</span>
                <div className="font-extrabold text-[#334155] mt-[2px]">
                  {selectedReq.requester?.name || selectedReq.createdBy?.name || 'Kinh Doanh'}
                </div>
                <div className="text-[13.5px] text-[#334155] mt-[2px] flex items-center gap-[6px]">
              ...
              <div>
                <span className="text-[13px] text-[#334155] font-bold uppercase">CHUYÊN VIÊN BÁO GIÁ</span>
              ...
              {(timeToAccept !== null || timeToQuote !== null || timeToReturn !== null || timeToReject !== null) && (
                <>
                  <div className="h-[1px] bg-[#f1f5f9]" />
                  <div>
                    <span className="text-[13px] text-[#334155] font-bold uppercase inline-flex items-center gap-[4px]">
                      THỜI GIAN XỬ LÝ
                      <span
                        title={
