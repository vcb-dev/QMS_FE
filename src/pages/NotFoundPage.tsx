    ...
    <div className="min-h-[70vh] flex items-center justify-center py-[32px] px-[20px] box-border">
      <div className="w-full max-w-[520px] bg-surface rounded-[24px] py-[40px] px-[32px] text-center shadow-[0_20px_40px_-15px_rgba(15,23,42,0.08),0_0_0_1px_#e2e8f0] flex flex-col items-center">
        ...
        <div className="relative mb-[20px] inline-flex items-center justify-center">
          <div className="text-[74px] font-black tracking-[-3px] leading-none bg-[linear-gradient(135deg,#cbd5e1_0%,#94a3b8_100%)] bg-clip-text text-transparent select-none">
            404
          </div>
        ...
        {/* Text Details */}
        <h2 className="text-[20px] font-extrabold text-text mt-0 mx-0 mb-[10px] tracking-[-0.2px]">
          {title}
        </h2>
        <p className="text-[15.5px] text-muted mt-0 mx-0 mb-[28px] leading-[1.5] max-w-[380px]">
          {description}
        </p>
        ...
        <div className="flex gap-[12px] justify-center w-full max-w-[360px] flex-wrap">
          <button
            type="button"
            onClick={handleBack}
            className="flex-1 min-w-[140px] inline-flex items-center justify-center gap-[8px] bg-text text-surface border-0 rounded-[12px] py-[12px] px-[18px] text-[15.5px] font-bold cursor-pointer shadow-[0_4px_12px_rgba(15,23,42,0.2)] transition-all duration-150 ease-out"
          >
          ...
          {showHome && (
            <button
              type="button"
              onClick={() => navigate('/')}
              className="flex-1 min-w-[140px] inline-flex items-center justify-center gap-[8px] bg-[#f8fafc] text-[#334155] border border-[#cbd5e1] rounded-[12px] py-[12px] px-[18px] text-[15.5px] font-bold cursor-pointer transition-all duration-150 ease-out"
            >
