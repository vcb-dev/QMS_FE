                      ...
                      <div key={row.id} className="grid [grid-template-columns:1fr_140px_36px] gap-[12px] items-center">
                        ...
                        <div className="relative">
                          <input
                            ...
                            placeholder="Số chỉ"
                            className={clsx('w-full pt-[9px] pr-[42px] pb-[9px] pl-[12px] rounded-[8px] text-[15px] font-bold outline-none bg-surface [font-variant-numeric:tabular-nums]', missingWeight ? 'border border-[#f87171]' : 'border border-[#cbd5e1]')}
                          />
                          <span className="absolute right-[12px] top-1/2 -translate-y-1/2 text-[14px] font-bold text-[#334155]">
                            chỉ
                          </span>
