...
export const CustomersPage: React.FC = () => {
  ...
  return (
    <div className="flex flex-col gap-[22px]">
      <div>
        <h1 className="text-[26px] font-black text-[#0f172a] m-0 tracking-[-0.3px]">
          Quản Lý Khách Hàng
        </h1>
        <p className="text-[15px] text-[#334155] mt-[4px] mr-0 mb-0 ml-0">
      ...
      <div className="bg-surface border border-border rounded-[14px] p-[20px] shadow-[0_1px_3px_rgba(0,0,0,0.03)]">
          ...
          <div className="flex items-center gap-[10px] flex-wrap">
            <div className="relative w-[260px]">
              ...
              <input
                ...
                className="w-full pt-[9px] pr-[12px] pb-[9px] pl-[34px] rounded-[8px] border border-[#cbd5e1] text-[14.5px] outline-none box-border"
              />
            </div>
            ...
            <div className="relative" ref={panelRef}>
              <button
                ...
                className={clsx(fbBtnCls, 'inline-flex items-center gap-[6px] py-[8px] px-[14px] text-[14.5px]')}
              >
                <SlidersHorizontal size={14} />
                Bộ lọc
                {panelFilterCount > 0 && (
                  <span className="bg-[#cbd5e1] text-[#0f172a] rounded-full text-[12.5px] font-black py-[1px] px-[6px] min-w-[16px] text-center">
                    {panelFilterCount}
                  </span>
                )}
              </button>
                    ...
                    <div className="flex gap-[6px] flex-wrap">
                      {([
                        ...
                        <button
                          ...
                          className={clsx(
                            'py-[6px] px-[12px] rounded-[6px] text-[13.5px] font-bold cursor-pointer',
            ...
            <button
              ...
              className={clsx(fbBtnCls, 'flex items-center gap-[4px] py-[8px] px-[14px] text-[14px] shrink-0')}
            >
          ...
          <div className="flex gap-[6px] flex-wrap">
            {([
              ...
              <button
                ...
                className={clsx(
                  'py-[7px] px-[12px] rounded-[8px] text-[13.5px] font-bold cursor-pointer',
                  sortMode === opt.key
                    ? 'bg-surface text-[#0f172a] border border-[#0f172a]'
        ...
        {loading ? (
          <div className="text-center text-faint text-[14.5px] py-[30px]">Đang tải...</div>
        ) : rows.length > 0 ? (
          <div className="flex flex-col gap-[8px]">
            {rows.map((s) => {
              ...
              return (
                <div key={s.customer.id} className="border border-[#f1f5f9] rounded-[10px] overflow-hidden">
                  ...
                  >
                    <div>
                      <div className="font-extrabold text-[#0f172a] text-[15px]">{s.customer.name}</div>
                      <div className="flex items-center gap-[10px] mt-[2px] text-[13px] text-muted">
                    ...
                    <div className="text-[14.5px] text-[#334155]">
                      <div className="text-[12px] text-faint font-bold uppercase">Tổng đơn</div>
                      {s.totalOrders}
                    </div>
                    <div className="text-[14.5px] text-[#334155]">
                      <div className="text-[12px] text-faint font-bold uppercase">Đã chốt</div>
                      {s.totalClosed}
                    </div>
                    <div className="text-[14.5px] text-muted">
                      <div className="text-[12px] text-faint font-bold uppercase">Đơn gần nhất</div>
                      {s.lastOrder ? new Date(s.lastOrder).toLocaleDateString('vi-VN') : '---'}
                    </div>
                    <div className="text-[15px] font-black text-tone-green-text">
                      <div className="text-[12px] text-faint font-bold uppercase">Giá trị đã chốt</div>
                  ...
                  {isExpanded && (
                    <div className="border-t border-[#f1f5f9] py-[12px] px-[14px] bg-[#fbfcfe]">
                      {orderState?.loading ? (
                        <div className="text-center text-faint text-[14px] py-[10px]">
                          Đang tải danh sách đơn...
                        </div>
                      ) : orderState?.error ? (
                        <div className="text-center text-[#dc2626] text-[14px] py-[10px]">
                          {orderState.error}
                        </div>
                        ...
                        <div className="flex flex-col gap-[6px]">
                          {[...orderState.data]
                            ...
                            .map((o) => {
                              ...
                              return (
                                <div key={o.id} className="grid grid-cols-[110px_1.6fr_1fr_0.9fr_1fr_1fr] gap-[10px] items-center text-[14px] py-[6px] border-b border-[#f1f5f9]">
                                  ...
                                  <span
                                    className="inline-flex items-center justify-center py-[2px] px-[8px] rounded-[20px] text-[12.5px] font-bold w-fit"
                                    // động — giữ inline
          ...
          <div className="text-center text-faint text-[14.5px] py-[30px]">Không tìm thấy khách hàng nào</div>
        )}
