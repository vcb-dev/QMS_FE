...
export const btnGhostSmallCls = 'flex items-center gap-[4px] bg-transparent border border-[#cbd5e1] rounded-[6px] py-[5px] px-[10px] text-[14px] font-bold text-[#334155] cursor-pointer';
export const iconBtnCls = 'bg-transparent border-0 cursor-pointer flex items-center justify-center p-[2px]';
export const pageBtnCls = (disabled: boolean) => clsx('py-[4px] px-[10px] rounded-[6px] border border-[#cbd5e1] bg-surface text-[14.5px] font-bold', disabled ? 'cursor-default opacity-50' : 'cursor-pointer');
...
export const formLabelCls = 'text-[15.5px] font-bold text-[#0f172a]';
export const formReqCls = 'text-[#ef4444]';
export const formControlCls =
  'w-full py-[9px] px-[12px] border border-border rounded-[8px] text-[16px] outline-none transition-[border-color_0.2s] focus:border-primary focus:shadow-[0_0_0_3px_rgba(37,99,235,0.1)]';

// ---- Nút Inspector / modal (.btn-insp*) ----
export const btnInspCls =
  'w-full py-[9px] px-[14px] rounded-[8px] text-[15.5px] font-bold border-0 cursor-pointer flex items-center justify-center gap-[6px] transition-[background_0.15s]';
...
export const toolBtnCls =
  'bg-white border border-border py-[7px] px-[12px] rounded-[8px] text-[15px] font-semibold text-[#0f172a] cursor-pointer inline-flex items-center gap-[6px] transition-[background_0.15s] hover:bg-[#f1f5f9]';

// ---- Status pill (.status-pill*) ----
export const statusPillCls =
  'inline-flex items-center justify-center gap-[4px] min-w-[118px] py-[4px] px-[10px] rounded-[20px] text-[14.5px] font-bold whitespace-nowrap shadow-[0_1px_3px_rgba(0,0,0,0.04)]';
...
export const selectCls =
  'appearance-none w-full bg-[#f8fafc] border border-[#cbd5e1] rounded-[8px] pt-[8px] pr-[30px] pb-[8px] pl-[12px] text-[15.5px] font-semibold text-[#334155] outline-none cursor-pointer box-border';
...
export const popoverLabelCls =
  'text-[13.5px] font-extrabold text-faint uppercase tracking-[0.4px] mb-[5px] block';
export const popoverSelectCls =
  'bg-[#f8fafc] border border-[#cbd5e1] rounded-[8px] py-[8px] pr-[30px] pl-[12px] text-[15.5px] font-semibold text-[#0f172a] outline-none cursor-pointer w-full appearance-none box-border';

// ---- Date inputs ----
// dateInputIconCls: w-full có thụt lề pl-[32px] chừa chỗ cho icon lịch (FilterBar, CustomersPage)
export const dateInputIconCls =
  'w-full bg-[#f8fafc] border border-[#cbd5e1] rounded-[8px] pt-[7px] pr-[10px] pb-[7px] pl-[32px] text-[15px] font-semibold text-[#334155] outline-none box-border';
// dateInputCls: w-full tiêu chuẩn không icon (LibraryPage)
export const dateInputCls =
  'w-full bg-[#f8fafc] border border-[#cbd5e1] rounded-[8px] py-[7px] px-[10px] text-[15px] font-semibold text-[#334155] outline-none box-border';
// dateInputNoFullCls: inline width, py-[7px] (MetalPriceHistoryModal)
export const dateInputNoFullCls =
  'bg-[#f8fafc] border border-[#cbd5e1] rounded-[8px] py-[7px] px-[10px] text-[15px] font-semibold text-[#334155] outline-none';
// dateInputPy6Cls: inline width, py-[6px] (StaffPage)
export const dateInputPy6Cls =
  'bg-[#f8fafc] border border-[#cbd5e1] rounded-[8px] py-[6px] px-[10px] text-[15px] font-semibold text-[#334155] outline-none';
...
// ---- CreateModal helpers ----
export const emptyStoneNoticeCls = 'py-[16px] px-[8px] text-[15px] text-faint text-center';
export const checkboxSmallCls = 'w-[15px] h-[15px] cursor-pointer accent-[#475569]';

// ---- CustomerSelectorSection ----
export const subLabelCls = 'text-[14px] font-bold text-[#334155]';

// ---- MetalPriceHistoryModal ----
export const metalThBaseCls =
  'sticky top-0 bg-[#f8fafc] text-[13.5px] font-extrabold text-muted uppercase tracking-[0.3px]';

// ---- PricingModal ----
export const labelUppercaseCls = 'text-[14px] font-extrabold text-[#475569] uppercase';
...
export const specEyebrowCls =
  'flex items-center justify-between gap-[8px] w-full min-h-[22px] mb-[16px] pb-[12px] border-b border-border text-[13.5px] font-extrabold tracking-[0.9px] uppercase text-muted';
export const specEyebrowLabelCls =
  'flex items-center gap-[6px] whitespace-nowrap [&_svg]:shrink-0';
export const specEmptyCls = 'text-[16px] text-faint';
export const specTodayLabelCls = 'text-[13px] font-bold tracking-[0.5px] uppercase text-faint';
export const specHistCardLineCls =
  'text-[14.5px] text-muted truncate [&_strong]:text-[#0f172a] [&_strong]:font-bold';

// ---- QuoteTable ----
export const quoteChipCls =
  'bg-[#f1f5f9] text-[#334155] py-[3px] px-[7px] rounded-[6px] text-[14px] font-semibold inline-block';

// ---- Sidebar ----
export const navBtnBaseCls =
  'w-full border border-transparent bg-transparent py-[11px] px-[14px] rounded-[12px] text-left text-[16.5px] font-semibold text-[#334155] cursor-pointer flex items-center justify-start transition-all duration-150 [&_svg]:shrink-0 hover:bg-[#f1f5f9] hover:text-[#0f172a]';
